...
(
    fk_gp2_placeID varchar(100) NOT NULL,
...
ADD CONSTRAINT fk_gp2_placeID
FOREIGN KEY (fk_gp2_placeID) REFERENCES place (placeID) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE chefmozaccepts
ADD CONSTRAINT fk_cma_placeID
FOREIGN KEY (fk_cma_placeID) REFERENCES place (placeID)
ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE chefmozcuisine
ADD CONSTRAINT fk_cmc_placeID
FOREIGN KEY (fk_cmc_placeID) REFERENCES place (placeID)
ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE chefmozcuisine
...
FOREIGN KEY (fk_cmh_placeID) REFERENCES place (placeID)
ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE chefmozparking
ADD CONSTRAINT fk_cmp_placeID
FOREIGN KEY (fk_cmp_placeID) REFERENCES place (placeID)
ON DELETE CASCADE ON UPDATE CASCADE;
...
FOREIGN KEY (fk_rf_placeID) REFERENCES place (placeID)
ON DELETE CASCADE ON UPDATE CASCADE;
